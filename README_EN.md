...
| F16 | [Inversion Thinking](https://github.com/peterfei/forge-skill-inversion-thinking-skill) | Decision/Risk | Flip problem perspective to discover hidden risks and solutions through reverse thinking | `npx skills add peterfei/forge-skill-inversion-thinking-skill` |
| F25 | [Mental Model Fusion](https://github.com/peterfei/forge-skill-mental-model-fusion-skill) | Meta-methodology/Multidisciplinary | Integrate core mental models from multiple disciplines into a latticework, avoid man-with-hammer syndrome | `npx skills add peterfei/forge-skill-mental-model-fusion-skill` |
